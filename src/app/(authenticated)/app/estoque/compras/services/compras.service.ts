...
export interface Compra { id: number; fornecedorId: number; dataCompra: string; valorTotal: number | null; status: StatusCompra; observacao: string | null; itens: CompraItem[]; createdAt: string; }
