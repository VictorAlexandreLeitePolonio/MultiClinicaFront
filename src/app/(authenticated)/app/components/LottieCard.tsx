...
export function LottieCard() {
  return (
    <motion.div
      ...
      className="bg-secondary rounded-xl border border-secondary-dark shadow-[0_18px_50px_-44px_rgba(15,23,42,0.6)] p-6 flex flex-col items-center justify-center relative overflow-hidden"
    >
      {/* Pattern overlay */}
      <div 
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="flex items-center gap-2 mt-3">
          ...
          <div className="w-1.5 h-1.5 bg-primary-dark rotate-45 border border-white/50" />
          <div className="h-px w-8 bg-white/30" />
        </div>
      </div>
    </motion.div>
