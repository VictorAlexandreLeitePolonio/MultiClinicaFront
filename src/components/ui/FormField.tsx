...
export const FormField = forwardRef<HTMLInputElement, FormFieldProps>(
  ({ label, error, id, disabled, value, onChange, onBlur, type = "text", placeholder, light = false, ...rest }, ref) => {
    ...
    return (
      <motion.div variants={fadeSlideUp} className="flex flex-col gap-2">
        ...
        <motion.input
          ...
          className={`w-full rounded-xl border px-4 py-3 transition-all duration-150 ${inputClassName}
